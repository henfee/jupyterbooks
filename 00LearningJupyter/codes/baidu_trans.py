...
def baidu_translate(texts):
    ''' use baidu tranlate api to translate English texts into Chinese,
     return list[src, dst], you can use return[0] or return[1] to choose'''
    ...
    sign = m1.hexdigest()
    myurls = myurl+'?appid='+appid+'&q='+ur.quote(q)+'&from='+fromLang+'&to='+toLang+'&salt='+str(salt)+'&sign='+sign
